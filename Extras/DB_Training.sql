...
--
-- Name: address; Type: TABLE; Schema: public; Owner: paco
--

CREATE TABLE address (
    keyaddress integer NOT NULL,
    street character varying(30) NOT NULL,
    intnum character varying(5),
    extnum character varying(5) NOT NULL,
    cp character varying(5),
    colony character varying(30) NOT NULL,
    keycity integer
);


ALTER TABLE address OWNER TO paco;

--
-- Name: address_keyaddress_seq; Type: SEQUENCE; Schema: public; Owner: paco
--

CREATE SEQUENCE address_keyaddress_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE address_keyaddress_seq OWNER TO paco;

--
-- Name: address_keyaddress_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: paco
--

ALTER SEQUENCE address_keyaddress_seq OWNED BY address.keyaddress;


--
-- Name: city; Type: TABLE; Schema: public; Owner: paco
--
...
ALTER TABLE city OWNER TO paco;

--
-- Name: company; Type: TABLE; Schema: public; Owner: paco
--

CREATE TABLE company (
    keycompany integer NOT NULL,
    namecompany character varying(30),
    emailcompany character varying(50),
    phone character varying(10),
    rfc character varying(18),
    bussinesturn character varying(30),
    keyaddress integer
);


ALTER TABLE company OWNER TO paco;

--
-- Name: company_keycompany_seq; Type: SEQUENCE; Schema: public; Owner: paco
--

CREATE SEQUENCE company_keycompany_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE company_keycompany_seq OWNER TO paco;

--
-- Name: company_keycompany_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: paco
--

ALTER SEQUENCE company_keycompany_seq OWNED BY company.keycompany;


--
-- Name: country; Type: TABLE; Schema: public; Owner: paco
--
...
ALTER TABLE country OWNER TO paco;

--
-- Name: course; Type: TABLE; Schema: public; Owner: paco
--

CREATE TABLE course (
    keycourse integer NOT NULL,
    namecourse character varying(30) NOT NULL,
    temary text,
    objetive text,
    keytypecourse integer
);


ALTER TABLE course OWNER TO paco;

--
-- Name: course_keycourse_seq; Type: SEQUENCE; Schema: public; Owner: paco
--

CREATE SEQUENCE course_keycourse_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE course_keycourse_seq OWNER TO paco;

--
-- Name: course_keycourse_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: paco
--

ALTER SEQUENCE course_keycourse_seq OWNED BY course.keycourse;


--
-- Name: course_training; Type: TABLE; Schema: public; Owner: paco
--

CREATE TABLE course_training (
    keycoursetraining integer NOT NULL,
    keycourse integer NOT NULL,
    keyinstructor integer,
    schedule text,
    startdate date,
    enddate date,
    ...
    starthour character varying(30),
    endhour character varying(30)
);


ALTER TABLE course_training OWNER TO paco;

--
-- Name: course_training_keycoursetraining_seq; Type: SEQUENCE; Schema: public; Owner: paco
--

CREATE SEQUENCE course_training_keycoursetraining_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE course_training_keycoursetraining_seq OWNER TO paco;

--
-- Name: course_training_keycoursetraining_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: paco
--

ALTER SEQUENCE course_training_keycoursetraining_seq OWNED BY course_training.keycoursetraining;


--
-- Name: employee; Type: TABLE; Schema: public; Owner: paco
--

CREATE TABLE employee (
    keyemployee integer NOT NULL,
    nameemp character varying(50) NOT NULL,
    lastname character varying(50) NOT NULL,
    lastnamemom character varying(50),
    borndate date NOT NULL,
    emailemp character varying(50) NOT NULL,
    phone character varying(10) NOT NULL,
    rfc character varying(18),
    keygender character varying(1),
    keyaddress integer,
    keyjob integer,
    keyuser integer
);
...
ALTER TABLE employee OWNER TO paco;

--
-- Name: employee_keyemployee_seq; Type: SEQUENCE; Schema: public; Owner: paco
--

CREATE SEQUENCE employee_keyemployee_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE employee_keyemployee_seq OWNER TO paco;

--
-- Name: employee_keyemployee_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: paco
--

ALTER SEQUENCE employee_keyemployee_seq OWNED BY employee.keyemployee;


--
-- Name: gender; Type: TABLE; Schema: public; Owner: paco
--

CREATE TABLE gender (
    keygender character varying(1) NOT NULL,
    description character varying(15) NOT NULL
);


ALTER TABLE gender OWNER TO paco;

--
-- Name: history; Type: TABLE; Schema: public; Owner: paco
--
...
ALTER TABLE history OWNER TO paco;

--
-- Name: history_keyhistory_seq; Type: SEQUENCE; Schema: public; Owner: paco
--
...
ALTER TABLE history_keyhistory_seq OWNER TO paco;

--
-- Name: history_keyhistory_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: paco
--
...
--
-- Name: instructor; Type: TABLE; Schema: public; Owner: paco
--

CREATE TABLE instructor (
    keyinstructor integer NOT NULL,
    nameinst character varying(30),
    lastname character varying(50),
    lastnamemom character varying(50),
    borndate date,
    emailins character varying(50),
    phone character varying(10),
    rfc character varying(18),
    keygender character varying(1),
    keyaddress integer,
...
ALTER TABLE instructor OWNER TO paco;

--
-- Name: instructor_keyinstructor_seq; Type: SEQUENCE; Schema: public; Owner: paco
--

CREATE SEQUENCE instructor_keyinstructor_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE instructor_keyinstructor_seq OWNER TO paco;

--
-- Name: instructor_keyinstructor_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: paco
--

ALTER SEQUENCE instructor_keyinstructor_seq OWNED BY instructor.keyinstructor;


--
-- Name: job; Type: TABLE; Schema: public; Owner: paco
--

CREATE TABLE job (
    keyjob integer NOT NULL,
    namejob character varying(50) NOT NULL
);


ALTER TABLE job OWNER TO paco;

--
-- Name: job_keyjob_seq; Type: SEQUENCE; Schema: public; Owner: paco
--
...
ALTER TABLE job_keyjob_seq OWNER TO paco;

--
-- Name: job_keyjob_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: paco
--
...
--
-- Name: log; Type: TABLE; Schema: public; Owner: paco
--

CREATE TABLE log (
    keyaccess integer NOT NULL,
...
ALTER TABLE log OWNER TO paco;

--
-- Name: log_keyaccess_seq; Type: SEQUENCE; Schema: public; Owner: paco
--

CREATE SEQUENCE log_keyaccess_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE log_keyaccess_seq OWNER TO paco;

--
-- Name: log_keyaccess_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: paco
--

ALTER SEQUENCE log_keyaccess_seq OWNED BY log.keyaccess;


--
-- Name: type_course; Type: TABLE; Schema: public; Owner: paco
--

CREATE TABLE type_course (
    keytypecourse integer NOT NULL,
    nametypecourse character varying(30) NOT NULL,
    description character varying(30)
);


ALTER TABLE type_course OWNER TO paco;

--
-- Name: type_course_keytypecourse_seq; Type: SEQUENCE; Schema: public; Owner: paco
--

CREATE SEQUENCE type_course_keytypecourse_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE type_course_keytypecourse_seq OWNER TO paco;

--
-- Name: type_course_keytypecourse_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: paco
--

ALTER SEQUENCE type_course_keytypecourse_seq OWNED BY type_course.keytypecourse;


--
-- Name: usr; Type: TABLE; Schema: public; Owner: paco
--

CREATE TABLE usr (
    keyuser integer NOT NULL,
    username character varying(50),
    userpass character(32)
);


ALTER TABLE usr OWNER TO paco;

--
-- Name: usr_keyuser_seq; Type: SEQUENCE; Schema: public; Owner: paco
--

CREATE SEQUENCE usr_keyuser_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE usr_keyuser_seq OWNER TO paco;

--
-- Name: usr_keyuser_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: paco
--

ALTER SEQUENCE usr_keyuser_seq OWNED BY usr.keyuser;


--
-- Name: keyaddress; Type: DEFAULT; Schema: public; Owner: paco
--

ALTER TABLE ONLY address ALTER COLUMN keyaddress SET DEFAULT nextval('address_keyaddress_seq'::regclass);


--
-- Name: keycompany; Type: DEFAULT; Schema: public; Owner: paco
--

ALTER TABLE ONLY company ALTER COLUMN keycompany SET DEFAULT nextval('company_keycompany_seq'::regclass);


--
-- Name: keycourse; Type: DEFAULT; Schema: public; Owner: paco
--

ALTER TABLE ONLY course ALTER COLUMN keycourse SET DEFAULT nextval('course_keycourse_seq'::regclass);


--
-- Name: keycoursetraining; Type: DEFAULT; Schema: public; Owner: paco
--

ALTER TABLE ONLY course_training ALTER COLUMN keycoursetraining SET DEFAULT nextval('course_training_keycoursetraining_seq'::regclass);


--
-- Name: keyemployee; Type: DEFAULT; Schema: public; Owner: paco
--

ALTER TABLE ONLY employee ALTER COLUMN keyemployee SET DEFAULT nextval('employee_keyemployee_seq'::regclass);


--
-- Name: keyhistory; Type: DEFAULT; Schema: public; Owner: paco
--

ALTER TABLE ONLY history ALTER COLUMN keyhistory SET DEFAULT nextval('history_keyhistory_seq'::regclass);


--
-- Name: keyinstructor; Type: DEFAULT; Schema: public; Owner: paco
--

ALTER TABLE ONLY instructor ALTER COLUMN keyinstructor SET DEFAULT nextval('instructor_keyinstructor_seq'::regclass);


--
-- Name: keyjob; Type: DEFAULT; Schema: public; Owner: paco
--

ALTER TABLE ONLY job ALTER COLUMN keyjob SET DEFAULT nextval('job_keyjob_seq'::regclass);


--
-- Name: keyaccess; Type: DEFAULT; Schema: public; Owner: paco
--

ALTER TABLE ONLY log ALTER COLUMN keyaccess SET DEFAULT nextval('log_keyaccess_seq'::regclass);


--
-- Name: keytypecourse; Type: DEFAULT; Schema: public; Owner: paco
--

ALTER TABLE ONLY type_course ALTER COLUMN keytypecourse SET DEFAULT nextval('type_course_keytypecourse_seq'::regclass);


--
-- Name: keyuser; Type: DEFAULT; Schema: public; Owner: paco
--

ALTER TABLE ONLY usr ALTER COLUMN keyuser SET DEFAULT nextval('usr_keyuser_seq'::regclass);


--
-- Data for Name: address; Type: TABLE DATA; Schema: public; Owner: paco
--

COPY address (keyaddress, street, intnum, extnum, cp, colony, keycity) FROM stdin;
1	Fco. Pimentel	\N	209A	38010	Fovissste	2556
2	Morelia	\N	319	36500	San Cristobal	2549
3	Paso de la muerte	\N	2014	36550	Las Carmelitas	2549
\.


--
-- Name: address_keyaddress_seq; Type: SEQUENCE SET; Schema: public; Owner: paco
--

SELECT pg_catalog.setval('address_keyaddress_seq', 3, true);


--
-- Data for Name: city; Type: TABLE DATA; Schema: public; Owner: paco
--
...
--
-- Data for Name: company; Type: TABLE DATA; Schema: public; Owner: paco
--

COPY company (keycompany, namecompany, emailcompany, phone, rfc, bussinesturn, keyaddress) FROM stdin;
1	ITC	itcelaya@itcelaya.edu.mx	612374	ITCE950115HGTDMR44	Education	\N
\.


--
-- Name: company_keycompany_seq; Type: SEQUENCE SET; Schema: public; Owner: paco
--

SELECT pg_catalog.setval('company_keycompany_seq', 1, true);


--
-- Data for Name: country; Type: TABLE DATA; Schema: public; Owner: paco
--
...
--
-- Data for Name: course; Type: TABLE DATA; Schema: public; Owner: paco
--

COPY course (keycourse, namecourse, temary, objetive, keytypecourse) FROM stdin;
1	Bases de Datos	1.- Diagrama relacional	Ser como DiosLao	\N
\.


--
-- Name: course_keycourse_seq; Type: SEQUENCE SET; Schema: public; Owner: paco
--

SELECT pg_catalog.setval('course_keycourse_seq', 1, true);


--
-- Data for Name: course_training; Type: TABLE DATA; Schema: public; Owner: paco
--

COPY course_training (keycoursetraining, keycourse, keyinstructor, schedule, startdate, enddate, price, capacity, hours, place, starthour, endhour) FROM stdin;
\.


--
-- Name: course_training_keycoursetraining_seq; Type: SEQUENCE SET; Schema: public; Owner: paco
--

SELECT pg_catalog.setval('course_training_keycoursetraining_seq', 1, false);


--
-- Data for Name: employee; Type: TABLE DATA; Schema: public; Owner: paco
--

COPY employee (keyemployee, nameemp, lastname, lastnamemom, borndate, emailemp, phone, rfc, keygender, keyaddress, keyjob, keyuser) FROM stdin;
1	Valeria	Caudillo	Matrinez	1995-01-29	14030085@itcelaya.edu.mx	4621137817	CAMA950129MGTDMR09	2	3	1	2
2	Felipe	Aguilar	Hernandez	1994-05-25	13030395@itcelaya.edu.mx	4611562817	AGHF940525HGTDMR15	1	1	2	3
3	Cipactly	Torres	Montenegro	1994-12-03	13030612@itcelaya.edu.mx	4111236430	TOMC951203MGTDMR30	2	\N	\N	\N
\.


--
-- Name: employee_keyemployee_seq; Type: SEQUENCE SET; Schema: public; Owner: paco
--

SELECT pg_catalog.setval('employee_keyemployee_seq', 3, true);


--
-- Data for Name: gender; Type: TABLE DATA; Schema: public; Owner: paco
--

COPY gender (keygender, description) FROM stdin;
1	Male
2	Female
\.
...
--
-- Data for Name: history; Type: TABLE DATA; Schema: public; Owner: paco
--

COPY history (keyhistory, keycoursetraining, keycourse, keyemployee, calification) FROM stdin;
\.


--
-- Name: history_keyhistory_seq; Type: SEQUENCE SET; Schema: public; Owner: paco
--
...
--
-- Data for Name: instructor; Type: TABLE DATA; Schema: public; Owner: paco
--

COPY instructor (keyinstructor, nameinst, lastname, lastnamemom, borndate, emailins, phone, rfc, keygender, keyaddress, keycompany) FROM stdin;
2	Geovanni	Garcia	Munoz	1995-01-15	14030399@itcelaya.edu.mx	4621303799	GAMG950115HGTDMR44	1	2	1
1	Cipa	Torres	Montenegro	1994-12-03	13030612@itcelaya.edu.mx	4111236430	TOMC951203MGTDMR30	2	2	1
3	Abigail	Cervantes	Diaz	1997-03-13	14030399@itcelaya.edu.mx	4621303799	DICA970313MGTDMR01	2	1	1
\.


--
-- Name: instructor_keyinstructor_seq; Type: SEQUENCE SET; Schema: public; Owner: paco
--

SELECT pg_catalog.setval('instructor_keyinstructor_seq', 4, true);


--
-- Data for Name: job; Type: TABLE DATA; Schema: public; Owner: paco
--

COPY job (keyjob, namejob) FROM stdin;
...
--
-- Name: job_keyjob_seq; Type: SEQUENCE SET; Schema: public; Owner: paco
--

SELECT pg_catalog.setval('job_keyjob_seq', 6, true);


--
-- Data for Name: log; Type: TABLE DATA; Schema: public; Owner: paco
--

COPY log (keyaccess, username, token, startdate, enddate) FROM stdin;
1	paco	eb641d3f3ab1b0a8d645c76fb2210bb1	2018-02-16 10:07:35.501776	2018-02-16 10:37:35.501776
\.


--
-- Name: log_keyaccess_seq; Type: SEQUENCE SET; Schema: public; Owner: paco
--

SELECT pg_catalog.setval('log_keyaccess_seq', 1, true);


--
-- Data for Name: type_course; Type: TABLE DATA; Schema: public; Owner: paco
--

COPY type_course (keytypecourse, nametypecourse, description) FROM stdin;
2	Diplomaed	The time is more than 50 hours
1	WorkShop	The time is less than 30 hours
\.


--
-- Name: type_course_keytypecourse_seq; Type: SEQUENCE SET; Schema: public; Owner: paco
--

SELECT pg_catalog.setval('type_course_keytypecourse_seq', 2, true);


--
-- Data for Name: usr; Type: TABLE DATA; Schema: public; Owner: paco
--

COPY usr (keyuser, username, userpass) FROM stdin;
1	paco	81dc9bdb52d04dc20036dbd8313ed055
2	Vale	6982436ac9c0d95cdc2182abbef7c951
3	Felipe	a05f43ec0207a949ceaa054023713ed6
4	Andy	708718e82ccc4c78ffb67b33737cd436
5	Miriam	d6bc91cb85f9efe2d65d4d8b11f6c953
6	Joanna	b43577e36c58228a66ffd68033ee7f21
\.


--
-- Name: usr_keyuser_seq; Type: SEQUENCE SET; Schema: public; Owner: paco
--

SELECT pg_catalog.setval('usr_keyuser_seq', 6, true);


--
-- Name: address_pk; Type: CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY address
    ADD CONSTRAINT address_pk PRIMARY KEY (keyaddress);


--
-- Name: city_pkey; Type: CONSTRAINT; Schema: public; Owner: paco
--
...
--
-- Name: company_pk; Type: CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY company
    ADD CONSTRAINT company_pk PRIMARY KEY (keycompany);


--
-- Name: country_pkey; Type: CONSTRAINT; Schema: public; Owner: paco
--
...
--
-- Name: course_pk; Type: CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY course
    ADD CONSTRAINT course_pk PRIMARY KEY (keycourse);


--
-- Name: course_training_pk; Type: CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY course_training
    ADD CONSTRAINT course_training_pk PRIMARY KEY (keycoursetraining, keycourse);


--
-- Name: employee_pk; Type: CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY employee
    ADD CONSTRAINT employee_pk PRIMARY KEY (keyemployee);


--
-- Name: gender_pk; Type: CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY gender
    ADD CONSTRAINT gender_pk PRIMARY KEY (keygender);


--
-- Name: history_pk; Type: CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY history
    ADD CONSTRAINT history_pk PRIMARY KEY (keyhistory, keycoursetraining, keycourse, keyemployee);


--
-- Name: instructor_pk; Type: CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY instructor
    ADD CONSTRAINT instructor_pk PRIMARY KEY (keyinstructor);


--
-- Name: job_pk; Type: CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY job
    ADD CONSTRAINT job_pk PRIMARY KEY (keyjob);


--
-- Name: log_pk; Type: CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY log
    ADD CONSTRAINT log_pk PRIMARY KEY (keyaccess);


--
-- Name: type_course_pk; Type: CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY type_course
    ADD CONSTRAINT type_course_pk PRIMARY KEY (keytypecourse);


--
-- Name: user_pk; Type: CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY usr
    ADD CONSTRAINT user_pk PRIMARY KEY (keyuser);


--
-- Name: address_fk; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY address
    ADD CONSTRAINT address_fk FOREIGN KEY (keycity) REFERENCES city(id);


--
-- Name: company_fk; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY company
    ADD CONSTRAINT company_fk FOREIGN KEY (keyaddress) REFERENCES address(keyaddress);


--
-- Name: country_capital_fkey; Type: FK CONSTRAINT; Schema: public; Owner: paco
--
...
--
-- Name: course_fk; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY course
    ADD CONSTRAINT course_fk FOREIGN KEY (keytypecourse) REFERENCES type_course(keytypecourse);


--
-- Name: course_training_fk1; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY course_training
    ADD CONSTRAINT course_training_fk1 FOREIGN KEY (keycourse) REFERENCES course(keycourse);


--
-- Name: course_training_fk2; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY course_training
    ADD CONSTRAINT course_training_fk2 FOREIGN KEY (keyinstructor) REFERENCES instructor(keyinstructor);


--
-- Name: employee_fk1; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY employee
    ADD CONSTRAINT employee_fk1 FOREIGN KEY (keyjob) REFERENCES job(keyjob);


--
-- Name: employee_fk2; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY employee
    ADD CONSTRAINT employee_fk2 FOREIGN KEY (keyuser) REFERENCES usr(keyuser);


--
-- Name: employee_fk3; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY employee
    ADD CONSTRAINT employee_fk3 FOREIGN KEY (keygender) REFERENCES gender(keygender);


--
-- Name: employee_fk4; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY employee
    ADD CONSTRAINT employee_fk4 FOREIGN KEY (keyaddress) REFERENCES address(keyaddress);


--
-- Name: history_fk1; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY history
    ADD CONSTRAINT history_fk1 FOREIGN KEY (keycoursetraining, keycourse) REFERENCES course_training(keycoursetraining, keycourse);


--
-- Name: history_fk3; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY history
    ADD CONSTRAINT history_fk3 FOREIGN KEY (keyemployee) REFERENCES employee(keyemployee);


--
-- Name: instructor_fk1; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY instructor
    ADD CONSTRAINT instructor_fk1 FOREIGN KEY (keygender) REFERENCES gender(keygender);


--
-- Name: instructor_fk2; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY instructor
    ADD CONSTRAINT instructor_fk2 FOREIGN KEY (keyaddress) REFERENCES address(keyaddress);


--
-- Name: instructor_fk3; Type: FK CONSTRAINT; Schema: public; Owner: paco
--

ALTER TABLE ONLY instructor
    ADD CONSTRAINT instructor_fk3 FOREIGN KEY (keycompany) REFERENCES company(keycompany);
